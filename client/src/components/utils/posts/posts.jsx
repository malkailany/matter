...
const Post = ({ data, removePost, profile = null }) => {
  ...
  return (
    <>
      <div className='meet-container'>
        <div className='meet-inner-container'>
          ...
          <div className='meet-post w-100'>
            <div className='meet-profile-name'>
              <a
                href={`/user/${data.publisher?.username ||
                  profile?.username ||
                  'doesntExist'}`}
              >
                {data.publisher?.name || profile?.username || 'Anonymous'}
              </a>
            </div>
            ...
            <div className='meet-post-footer'>
              ...
              <div className='meet-post-actions '>
                {user._id == data.publisher._id || user._id == profile?._id ? (
                  <>
                    <button
        ...
        <div className='meet-comment-container'>
          <hr />
          ...
          <hr />
          <Comment postId={data._id} isCommenting />
        </div>
      </div>
    </>
  )
